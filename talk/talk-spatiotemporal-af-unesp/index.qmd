...
image: featured.jpg
date: 2023-06-14
event: ZooEco+, Unesp, Rio Claro, SP
categories: ["Palestra"]
format:
  html:
    include-in-header: 
...
<div class="mt-4 d-flex flex-row flex-wrap gap-1 justify-content-left justify-content-sm-start" role="group" aria-label="Links">
  <a href="https://docs.google.com/presentation/d/1aqKthjjG7fYeVhwGMQhq-vE5SyMGP4PF2pa038TnVmY/edit#slide=id.g1e1b7c54877_0_0" class="btn btn-custom text-capitalize" target="_blank"><i class="fas fa-images me-1"></i>Slides</a>
</div>

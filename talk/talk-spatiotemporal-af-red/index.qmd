...
image: featured.jpg
date: 2024-03-25
event: Red Trinacional de Restauración del Bosque Atlántico (Remoto)
categories: ["Palestra"]
format:
  html:
    include-in-header: 
...
<div class="mt-4 d-flex flex-row flex-wrap gap-1 justify-content-left justify-content-sm-start" role="group" aria-label="Links">
  <a href="https://docs.google.com/presentation/d/1XDmpxJZmS_MSaiA7V1gRRyZAFwdnX8KFHGLSbTtCH7U/edit?usp=sharing" class="btn btn-custom text-capitalize" target="_blank"><i class="fas fa-images me-1"></i>Slides</a>
</div>

...
<div style="display: flex; gap: 1.5em; flex-wrap: wrap;">
  <a href="https://doi.org/10.1016/j.biocon.2017.02.033" class="btn-outline" role="button" target="_blank" aria-label="DOI do artigo">
    {{< ai doi >}} DOI
  </a>
  
  <a href="2017-beca-etal.pdf" class="btn-outline" role="button" target="_blank" aria-label="CV em PDF">
